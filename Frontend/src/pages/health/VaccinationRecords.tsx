      ...
      <div className="max-w-7xl mx-auto">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between gap-4">
            ...
            <div className="flex flex-wrap gap-3">
              <motion.button
                ...
                whileTap={{ scale: 0.95 }}
                onClick={() => {
                  // TODO: Implementar navegación a formulario de nuevo registro
                  console.log("Navegar a nuevo registro");
                }}
        ...
        >
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                <p className="text-gray-600 text-sm font-medium">Con Reacciones</p>
                <p className="text-3xl font-bold text-orange-600">{stats.withReactions}</p>
              </div>
          ...
          <div className="bg-white/95 backdrop-blur-sm rounded-xl p-6 shadow-lg border border-white/20">
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-3xl font-bold text-emerald-600">${stats.totalCost.toFixed(2)}</p>
              </div>
        ...
        {isLoading ? (
          ...
          >
            ...
            />
            <p className="text-gray-600 text-lg">Cargando registros de vacunación...</p>
          </motion.div>
        ) : (
          <>
            {/* Lista de registros */}
            <motion.div
              ...
              className="bg-white/95 backdrop-blur-sm rounded-xl shadow-lg border border-white/20 overflow-hidden mb-8"
            >
